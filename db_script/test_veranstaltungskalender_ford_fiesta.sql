...
CREATE DATABASE IF NOT EXISTS test_event_management_db;

-- Drop DB
-- DROP DATABASE IF EXISTS event_management_db;

-- Verwende die erstellte Datenbank
USE test_event_management_db;
...
(37, 13, 'Unangemessenes Verhalten', 'Während des Events wurden laute Streitigkeiten gehört.'),
(39, 14, 'Irreführende Informationen', 'Die Eventbeschreibung stimmte nicht mit dem tatsächlichen Event überein.'),
(40, 13, 'Unzulässige Werbung', 'Es wurden unzulässige Werbematerialien verteilt.'),
(41, 14, 'Nicht eingehaltene Sicherheitsvorschriften', 'Die Sicherheitsvorschriften wurden während des Events nicht beachtet.'),
(34, 13, 'Störung der Veranstaltung', 'Es kam zu wiederholten Störungen durch einen Teilnehmer.'),
(39, 14, 'Unangemessene Sprache', 'Es wurde unangemessene Sprache verwendet, die andere Teilnehmer belästigte.'),
(40, 13, 'Fehlende Anmeldung', 'Ein Teilnehmer nahm ohne Anmeldung am Event teil.'),
(41, 14, 'Unfreundliches Verhalten', 'Ein Teilnehmer zeigte unfreundliches Verhalten gegenüber anderen Gästen.'),
(37, 13, 'Unzureichende Ausstattung', 'Die Veranstaltung war nicht wie angekündigt ausgestattet.'),
(39, 14, 'Unrechtmäßiger Zugang', 'Ein nicht autorisierter Personenkreis hatte Zugang zum Event.');
